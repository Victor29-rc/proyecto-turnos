<x-app-layout>
    <div class="max-w-7xl py-6 mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div class="grid-cols-1">
            <div class="mb-4">
                <Strong class="text-indigo-500">Turnos en cola: </Strong><input id="AmountShifts" type="button" value="{{$ShiftList}}" class="rounded-full py-2 px-4 mb-4 border-2 border-indigo-500 bg-gray-100 text-indigo-500">
            </div>
            ...
            <div class="mb-4">
                ...
                @if (isset($shift))
                    ...
                    @if($shift[0]->status != '1')  
                        <a href="{{ route('shifts.callNext') }}"><input class="bg-blue-300 px-4 py-2 rounded" type="button"
                            value="SIGUIENTE"></a>
                        @else
                            <input class="px-4 py-2 rounded" type="button"
                                value="SIGUIENTE">
                    @endif
